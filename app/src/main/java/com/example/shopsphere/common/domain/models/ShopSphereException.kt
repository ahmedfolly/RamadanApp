...
sealed class ShopSphereException(errorMessage: String) : Exception(errorMessage) {
	// Server-related exceptions
	sealed class ServerException(message: String) : ShopSphereException(message) {
	...
	sealed class NetworkException(override val message: String?) :
		ShopSphereException(message.orEmpty()) {
	...
	sealed class AuthenticationException(message: String) : ShopSphereException(message) {
	...
	sealed class StorageException(message: String) : ShopSphereException(message) {
	...
	sealed class HTTPException(open val code: Int, message: String) : ShopSphereException(message) {
